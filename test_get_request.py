...
class TestRequest:
    ...
    def test_case_login(self):
        TestRequest.url = "http://higher8pre.douxiangapp.com/dboxAdmin/v1/security/manageLogin"
    ...
    def test_case_collection(self):
        ...
        common_parameter = {Accept: application/json, text/plain, */*,
        Accept-Language: zh-CN,zh;q=0.9,Authorization:TestRequest.token,
        }
